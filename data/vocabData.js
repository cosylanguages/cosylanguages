 // Data sets with full phrases/statements
    const vocabData = {
      COSYenglish: {
        ...
        8: ["Police offcer", "Policeman", "Policewoman", "Businessperson", "Businesswoman", "Businessman", "Singer", "Chef", "Cook", "Firefighter", "Actor", "Actress", "Waiter", "Waitress", "Doctor", "Teacher", "Prgrammer", "Salesperson", "Salesman", "Saleswoman"],
        9: []
      },
      COSYfrançais: {
      ...
      COSYportuguês: {
        ...
        2: ["O rapaz", "A rapariga", "O professor", "A professora", "O estudante", "A estudante", "A mulher", "O homem"]
      },
      COSYdeutsch: {
